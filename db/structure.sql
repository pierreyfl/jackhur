...
CREATE TABLE `favors` (
  ...
  `visibility` varchar(255) DEFAULT 'everybody',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `messages` (
  ...
  `video_file_size` int DEFAULT NULL,
  `video_updated_at` datetime DEFAULT NULL,
  `counter_offer` float DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `people_smerf_forms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `people_smerf_forms` (
  `id` int NOT NULL AUTO_INCREMENT,
  `person_id` int NOT NULL,
  `smerf_form_id` int NOT NULL,
...
CREATE TABLE `settings` (
  `id` int NOT NULL AUTO_INCREMENT,
  `email_when_new_message` int DEFAULT '1',
  `email_when_new_comment` int DEFAULT '1',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `person_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `smerf_responses` (
  `id` int NOT NULL AUTO_INCREMENT,
  `people_smerf_form_id` int NOT NULL,
